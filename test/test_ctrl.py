...
if __name__ == '__main__':
    bad_path = '/home/chengyiqiu/code/SanDiffusion/results/classifier/gtsrb/ctrl/bd_test_dataset/10'
    device = 'cuda:0'
    batch = 128
    trans = T.Compose([
    ...
    ld = torch.load('/home/chengyiqiu/code/SanDiffusion/results/classifier/gtsrb/ctrl/attack_result.pt')
