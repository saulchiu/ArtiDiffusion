...
if __name__ == '__main__':
    bad_path = '/home/chengyiqiu/code/SanDiffusion/dataset/dataset-gtsrb-bad-wanet-0.1'
    device = 'cuda:0'
    batch = 128
    trans = T.Compose([
    ...
    ld = torch.load('/home/chengyiqiu/code/SanDiffusion/results/classifier/gtsrb/wanet/gtsrb_all2one.pth')
    net = PreActResNet18(num_classes=43).to(device)
    net.load_state_dict(ld['netC'])
    total = 0
    backdoor_acc = 0
    target_label = 0
    net.eval()
