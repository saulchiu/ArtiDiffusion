...
def get_ftrojan_transform(image_size, magnitude=30):
    channel_list = [1, 2]
    magnitude = magnitude
    YUV = True
    window_size = 32
    pos_list = [(15, 15), (31, 31)]
    bd_transform = ftrojann_version(YUV=YUV, channel_list=channel_list, window_size=window_size, magnitude=magnitude,
                                    pos_list=pos_list)
