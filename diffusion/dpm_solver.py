...
class NoiseScheduleVP:
    def __init__(
        ...
        ***
        Update: We support discrete-time diffusion classifier_models by implementing a picewise linear interpolation for log_alpha_t.
                We recommend to use schedule='discrete' for the discrete-time diffusion classifier_models, especially for high-resolution images.
        ***
    ...
    def numerical_clip_alpha(self, log_alphas, clipped_lambda=-5.1):
        ...
        Such a trick is very useful for diffusion classifier_models with the cosine schedule, such as i-DDPM, guided-diffusion and GLIDE.
        """
...
def model_wrapper(
    ...
    We support four types of the diffusion model by setting `model_type`:
        ...
        3. "v": velocity prediction model. (Trained by predicting the velocity).
            ...
            [1] Salimans, Tim, and Jonathan Ho. "Progressive distillation for fast sampling of diffusion classifier_models."
    ...
    We support three types of guided sampling by DPMs by setting `guidance_type`:
        ...
        2. "classifier": classifier guidance sampling [3] by DPMs and another classifier.
            ...
            [3] P. Dhariwal and A. Q. Nichol, "Diffusion classifier_models beat GANs on image synthesis,"
...
class DPM_Solver:
    def __init__(
        ...
        We also support the "dynamic thresholding" method in Imagen[1]. For pixel-space diffusion classifier_models, you
        ...
        [1] Chitwan Saharia, William Chan, Saurabh Saxena, Lala Li, Jay Whang, Emily Denton, Seyed Kamyar Seyed Ghasemipour,
            Burcu Karagol Ayan, S Sara Mahdavi, Rapha Gontijo Lopes, et al. Photorealistic text-to-image diffusion classifier_models
    ...
    def dpm_solver_adaptive(self, x, order, t_T, t_0, h_init=0.05, atol=0.0078, rtol=0.05, theta=0.9, t_err=1e-5,
        ...
        [1] A. Jolicoeur-Martineau, K. Li, R. Pich�-Taillefer, T. Kachman, and I. Mitliagkas, "Gotta go fast when generating data with score-based classifier_models," arXiv preprint arXiv:2105.14080, 2021.
        """
        ns = self.noise_schedule
    ...
    def sample(self, x, steps=20, t_start=None, t_end=None, order=2, skip_type='time_uniform',
        ...
        Args:
            ...
            denoise_to_zero: A `bool`. Whether to denoise to time 0 at the final step.
                ...
                for diffusion classifier_models sampling by diffusion SDEs for low-resolutional images
